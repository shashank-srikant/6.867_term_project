...
\todo{some discussion on why we think the number of iterations is so low -- perhaps something about vanishing gradients, or just it makes a more complex loss landscape?}
