...
\begin{itemize}[noitemsep,topsep=0pt]
	\item \textbf{E1.} Do GNNs capture the inductive bias in representing prediction tasks with a graph-like structure?
	\item \textbf{E2.} What structural information in the graph network affects its predictability in the specific task of predicting types?
