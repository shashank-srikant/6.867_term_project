...
\begin{figure}
	...
	\begin{subfigure}{0.49\linewidth}
		...
		\label{fig:g2}
	\end{subfigure}
	\caption{A summary of key dataset statistics, showing the CDFs of the average path length, the diameter of the graphs, and the average node degrees of the graphs in the dataset. }
