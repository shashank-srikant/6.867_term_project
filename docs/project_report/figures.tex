...
\begin{figure}
	...
	\caption{Aggressive baseline - A bi-directional RNN designed by Allamanis et al. \cite{hellendoorn2018deep}. It models type inference as a sequence prediction task in NLP.}
	\label{fig:birnn}
\end{figure}
%</baseline>
