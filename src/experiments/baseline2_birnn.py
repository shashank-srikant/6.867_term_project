...
basedir = '../6.867_term_project/data/repo/6867/data-final-with-src/'
files = {
	'train': { 'file': basedir+'data/train.ctf', 'location': 0 },
	'valid': { 'file': basedir+'data/valid.ctf', 'location': 0 },
	'test': { 'file': basedir+'data/test.ctf', 'location': 0 },
	'source': { 'file': basedir+'data/source_wl', 'location': 1 },
	'target': { 'file': basedir+'data/target_wl', 'location': 1 }
}
...
def train():
	...
	for epoch in range(num_epochs):
		...
		trainer.save_checkpoint(basedir+"data/models/model-" + str(epoch + 1) + ".cntk")
		validate()
		evaluate()
