...
import { get_block_variable_names_in_fn, getNodes, get_block_identifiers, pass_null_check, is_assign_op} from "./utils"
    ...
    private visit_block(node: ts.Node, node_map: Map<ts.Node, number>, 
        ...
        switch(node.kind){
            case ts.SyntaxKind.VariableDeclaration: {
                let var_names_define = Array.from(get_block_variable_names_in_fn(node));
